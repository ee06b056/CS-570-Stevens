...
function countIndegree (graph: number[][]): number[][] {
    let id:number[][] = [];
...
function topologicalSort_1 (graph: number[][]) {
    let id_0 = [];
    while (graph.length > 0){
        let id: number[][] = countIndegree(graph);
...
function topologicalSort_2 (graph: number[][]) {
    let id_0 = [];
    while (graph.length > 0){
        let id: number[][] = countIndegree(graph);
        let index:number;
